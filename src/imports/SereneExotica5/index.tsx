import svgPaths from "./svg-4qygit13sh";
...
function Container() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#4b5563] text-[16px] text-center w-full">
...
function Button() {
  return (
    <div className="bg-[#1a1a1a] content-stretch drop-shadow-[0px_4px_7.5px_rgba(212,175,55,0.15)] flex flex-[1_0_0] flex-col items-center justify-center min-w-px py-[16px] relative rounded-[16px]" data-name="Button">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#f3f4f6] text-[16px] text-center tracking-[0.0156px] whitespace-nowrap">
        <p className="leading-[20px]">Book a Site Visit</p>
      </div>
    </div>
  );
}
...
function SectionHero() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[11.4px] h-[778px] items-center left-1/2 top-[87px] w-[335px]" data-name="Section-hero">
...
function Heading2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 2">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1a1a1a] text-[0px] text-center w-full">
...
function Container7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Medium_Italic',sans-serif] italic justify-center leading-[0] relative shrink-0 text-[#0b2c24] text-[16px] text-center w-full">
...
function SectionUnique() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[24px] h-[1252px] items-start left-1/2 px-[20px] py-[64px] top-[1995px] w-[375px]" data-name="Section-Unique">
      <Heading2 />
      <Container3 />
      <Container5 />
    </div>
...
function Heading3() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Heading 2">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[26px] text-center text-white tracking-[0.0254px] whitespace-nowrap">
...
function Container14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.6)] text-center tracking-[1px] uppercase w-full">
...
function Container18() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[0px] text-[rgba(255,255,255,0.6)] text-center tracking-[1px] uppercase w-full">
        <p>
          <span className="leading-[15px] text-[12px]">Sports</span>
          <span className="leading-[15px] text-[10px]">{` Zone`}</span>
        </p>
      </div>
    </div>
  );
...
function SectionHighlights() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#0b2c24] content-stretch flex flex-col gap-[32px] items-start left-1/2 px-[20px] py-[48px] rounded-[40px] top-[3253px] w-[375px]" data-name="Section-highlights">
      <Container9 />
      <Container10 />
    </div>
  );
...
function Heading4() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading 2">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1a1a1a] text-[26px] text-center tracking-[0.0254px] whitespace-nowrap">
        <p className="leading-[30px] mb-0 whitespace-pre">{`Thoughtfully Planned `}</p>
        <p className="leading-[30px] whitespace-pre">Villa Plots</p>
      </div>
    </div>
  );
}
...
function Container35() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#4b5563] text-[16px] text-center tracking-[0.0313px] whitespace-nowrap">
        <p className="leading-[20px] mb-0 whitespace-pre">{`Designed for Premium Living & `}</p>
        <p className="leading-[20px] whitespace-pre">Future Value</p>
      </div>
    </div>
  );
}
...
function Container37() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Font_Awesome_5_Free:Solid',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-white tracking-[8px] whitespace-nowrap">
...
function Button1() {
  return (
    <div className="bg-[#0b2c24] content-stretch flex gap-[12px] items-center justify-center py-[16px] relative rounded-[16px] shrink-0 w-full" data-name="Button">
      <Container37 />
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-white w-[194px]">
        <p className="leading-[24px]">Download Masterplan</p>
      </div>
    </div>
  );
}
...
function Heading5() {
  return (
    <div className="col-[1/span_2] justify-self-stretch relative row-1 self-start shrink-0" data-name="Heading 3">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center px-[10px] relative size-full">
          <div className="[word-break:break-word] flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1a1a1a] text-[22px] text-center tracking-[0.0215px] whitespace-nowrap">
            <p className="leading-[17px]">Plot Sizes</p>
          </div>
        </div>
      </div>
    </div>
...
function Container38() {
  return (
    <div className="gap-x-[16px] gap-y-[20px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[__fit-content(100%)_281.00px] relative shrink-0 w-full" data-name="Container">
...
function Section() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[12px] items-start left-1/2 px-[20px] py-[64px] top-[3859px] w-[375px]" data-name="Section">
      <Heading4 />
      <Container35 />
      <BackgroundBorder />
      <ButtonMargin />
...
function Heading6() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading 2">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1a1a1a] text-[26px] text-center w-full">
...
function Section1() {
  return (
    <div className="-translate-x-1/2 absolute bg-white content-stretch flex flex-col gap-[8px] items-start left-1/2 px-[20px] py-[48px] top-[5276px] w-[375px]" data-name="Section">
      <Heading6 />
      <OverlayShadow1 />
      <Container49 />
    </div>
...
function Heading8() {
  return (
    <div className="content-stretch flex flex-col items-start pr-[16px] relative shrink-0" data-name="Heading 4">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1a1a1a] text-[16px] tracking-[0.0313px] whitespace-nowrap">
        <ol className="list-decimal mb-0" start="1">
          <li className="ms-[24px]">
            <span className="leading-[20px]">{`Where is Serene Exotica `}</span>
          </li>
        </ol>
        <p className="leading-[20px] whitespace-pre">located?</p>
      </div>
    </div>
  );
}
...
function Container77() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#4a4a4a] text-[14px] w-full">
...
function Heading9() {
  return (
    <div className="content-stretch flex flex-col items-start pr-[16px] relative shrink-0" data-name="Heading 4">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black tracking-[0.0313px] whitespace-nowrap">
        <ol className="list-decimal mb-0" start="2">
          <li className="ms-[24px]">
            <span className="leading-[20px]">{`What is the total project area `}</span>
          </li>
        </ol>
        <p className="leading-[20px] whitespace-pre">{`of  Serene Exotica?`}</p>
      </div>
    </div>
  );
}
...
function Heading10() {
  return (
    <div className="content-stretch flex flex-col items-start mr-[-42.12px] pr-[56.12px] relative shrink-0" data-name="Heading 4">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black tracking-[0.0313px] whitespace-nowrap">
...
function Heading11() {
  return (
    <div className="content-stretch flex flex-col items-start mr-[-21.98px] pr-[55.98px] relative shrink-0" data-name="Heading 4">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black tracking-[0.0313px] w-[249px]">
        <p className="leading-[20px]">4. Is Serene Exotica approved and ready for registration?</p>
      </div>
    </div>
  );
}
...
function Heading12() {
  return (
    <div className="content-stretch flex flex-col items-start pr-[16px] relative shrink-0" data-name="Heading 4">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black tracking-[0.0156px] whitespace-nowrap">
        <p className="leading-[20px] mb-0">5. Are loan options available for</p>
        <p className="leading-[20px]">plots at Serene Exotica?</p>
      </div>
    </div>
  );
}
...
function Heading13() {
  return (
    <div className="content-stretch flex flex-col items-start mr-[-4px] pr-[16px] relative shrink-0" data-name="Heading 4">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black tracking-[0.0469px] whitespace-nowrap">
...
function Section2() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#fcfaf7] content-stretch flex flex-col gap-[32px] h-[1503px] items-start left-1/2 px-[20px] py-[64px] top-[6043px] w-[375px]" data-name="Section">
      <Heading7 />
      <Container74 />
    </div>
  );
...
function Container93() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[8.7px] relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-[rgba(255,255,255,0.6)] text-center w-full">
        <p className="leading-[22.75px] mb-0">{`Where nature, connectivity & investment`}</p>
        <p className="leading-[22.75px]">potential come together.</p>
      </div>
    </div>
...
function Container96() {
  return (
    <div className="content-stretch flex flex-col items-start pr-[38.66px] relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-[rgba(255,255,255,0.8)] tracking-[0.0156px] whitespace-nowrap">
...
function Container99() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-[rgba(255,255,255,0.8)] tracking-[0.0781px] whitespace-nowrap">
...
function Container102() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-[rgba(255,255,255,0.8)] tracking-[0.0625px] whitespace-nowrap">
...
function Container103() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#d4af37] text-[12px] tracking-[1px] uppercase w-full">
...
function Container104() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-[rgba(255,255,255,0.7)] w-full">
...
function Container106() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.3)] tracking-[1px] uppercase w-[179px]">
...
function Footer() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#0b2c24] content-stretch flex flex-col gap-[23.3px] h-[641px] items-center left-1/2 pb-[128px] pt-[64px] px-[24px] rounded-tl-[40px] rounded-tr-[40px] top-[8803px] w-[375px]" data-name="Footer">
      <div className="h-[68px] relative shrink-0 w-[180px]">
...
function Container115() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[0.7px] relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#4b5563] text-[16px] text-center w-full whitespace-pre-wrap">
        <p className="leading-[22.75px] mb-0">{`With growing infrastructure, industrial expansion, and increasing residential demand, Serene Exotica stands at the center of Malur’s next phase `}</p>
        <p className="leading-[22.75px]">of growth.</p>
      </div>
    </div>
  );
}
...
function Container118() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Poppins:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1a1a1a] text-[14px] text-center w-full">
...
function Section3() {
  return (
    <div className="-translate-x-1/2 absolute bg-white content-stretch flex flex-col gap-[23.4px] items-start left-1/2 px-[20px] py-[48px] rounded-tl-[40px] rounded-tr-[40px] top-[865px] w-[375px]" data-name="Section">
...
function Seo() {
  return (
    <div className="-translate-x-1/2 absolute bg-white content-stretch flex flex-col gap-[23.4px] items-start left-1/2 px-[20px] py-[48px] rounded-tl-[40px] rounded-tr-[40px] top-[7604px] w-[375px]" data-name="SEO">
...
export default function SereneExotica() {
  return (
    <div className="bg-[#fcfaf7] relative size-full" data-name="Serene Exotica_5">
      <SectionHero />
      <SectionUnique />
      <SectionHighlights />
      <Section />
